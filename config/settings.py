...
DEFAULT_LITELLM_FAST_MODEL = "polaris-local-fast"
DEFAULT_LITELLM_REASONING_MODEL = "polaris-local-reasoning"
DEFAULT_LITELLM_SYNTHESIS_MODEL = "polaris-local-synthesis"
...
DEFAULT_RAG_HYDE_MODEL = DEFAULT_LITELLM_REASONING_MODEL
...
DEFAULT_RAG_CRAG_GRADER_MODEL = DEFAULT_LITELLM_STRUCTURED_MODEL
DEFAULT_RAG_CRAG_QUERY_REWRITE_MODEL = DEFAULT_LITELLM_STRUCTURED_MODEL
DEFAULT_RAG_SELF_REFLECTION_MODEL = DEFAULT_LITELLM_STRUCTURED_MODEL
DEFAULT_RAG_SYNTHESIS_MODEL = DEFAULT_LITELLM_SYNTHESIS_MODEL
DEFAULT_RAG_STRUCTURED_MAX_TOKENS = 512
DEFAULT_RAG_HYDE_MAX_TOKENS = 768
DEFAULT_RAG_SYNTHESIS_MAX_TOKENS = 1536
...
DEFAULT_DSPY_OPTIMIZATION_MODEL = DEFAULT_LITELLM_OPTIMIZATION_MODEL
...
class Settings(BaseSettings):
    ...
    DEFAULT_MODEL: str = DEFAULT_LITELLM_SYNTHESIS_MODEL
    ...
    RAG_ADAPTIVE_TRIAGE_MODEL: str = Field(
        default=DEFAULT_RAG_ADAPTIVE_TRIAGE_MODEL,
        validation_alias=AliasChoices(
            "POLARIS_RAG_ADAPTIVE_TRIAGE_MODEL",
            "RAG_ADAPTIVE_TRIAGE_MODEL",
        ),
    )
    RAG_ROUTE_SELECTION_MODEL: str = Field(
        default=DEFAULT_RAG_ROUTE_SELECTION_MODEL,
        validation_alias=AliasChoices(
    ...
    RAG_HYDE_MODEL: str = Field(
        default=DEFAULT_RAG_HYDE_MODEL,
        validation_alias=AliasChoices(
            "POLARIS_RAG_HYDE_MODEL",
            "RAG_HYDE_MODEL",
        ),
    )
    RAG_HYBRID_EMBEDDING_MODEL: str = Field(
        default=DEFAULT_RAG_HYBRID_EMBEDDING_MODEL,
        validation_alias=AliasChoices(
    ...
    RAG_RERANKER_MODEL: str = Field(
        default=DEFAULT_RAG_RERANKER_MODEL,
        validation_alias=AliasChoices(
    ...
    RAG_CRAG_GRADER_MODEL: str = Field(
        default=DEFAULT_RAG_CRAG_GRADER_MODEL,
        validation_alias=AliasChoices(
            "POLARIS_RAG_CRAG_GRADER_MODEL",
            "RAG_CRAG_GRADER_MODEL",
        ),
    )
    RAG_CRAG_QUERY_REWRITE_MODEL: str = Field(
        default=DEFAULT_RAG_CRAG_QUERY_REWRITE_MODEL,
        validation_alias=AliasChoices(
            "POLARIS_RAG_CRAG_QUERY_REWRITE_MODEL",
            "RAG_CRAG_QUERY_REWRITE_MODEL",
        ),
    )
    RAG_SELF_REFLECTION_MODEL: str = Field(
        default=DEFAULT_RAG_SELF_REFLECTION_MODEL,
        validation_alias=AliasChoices(
            "POLARIS_RAG_SELF_REFLECTION_MODEL",
            "RAG_SELF_REFLECTION_MODEL",
        ),
    )
    RAG_SYNTHESIS_MODEL: str = Field(
        default=DEFAULT_RAG_SYNTHESIS_MODEL,
        validation_alias=AliasChoices(
            "POLARIS_RAG_SYNTHESIS_MODEL",
            "RAG_SYNTHESIS_MODEL",
        ),
    )
    RAG_STRUCTURED_MAX_TOKENS: int = Field(
        default=DEFAULT_RAG_STRUCTURED_MAX_TOKENS,
        gt=0,
        validation_alias=AliasChoices(
    ...
    RAG_HYDE_MAX_TOKENS: int = Field(
        default=DEFAULT_RAG_HYDE_MAX_TOKENS,
        gt=0,
        validation_alias=AliasChoices(
    ...
    RAG_SYNTHESIS_MAX_TOKENS: int = Field(
        default=DEFAULT_RAG_SYNTHESIS_MAX_TOKENS,
        gt=0,
        validation_alias=AliasChoices(
