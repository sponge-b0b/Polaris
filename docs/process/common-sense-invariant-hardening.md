...
**Canonical index updated:** 2026-09-07
...
5. `docs/process/common-sense-invariant-hardening-attention-propagation-addendum.md` — proactive downstream-contract propagation Attention after material semantic, authority, architecture, vocabulary, or sequencing changes, while preserving the boundary that Attention grants no mutation authority.
