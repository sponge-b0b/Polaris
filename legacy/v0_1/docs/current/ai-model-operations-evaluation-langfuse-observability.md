...
For the full evaluation architecture, dataset catalog, threshold policy, CLI workflow, and test commands, see `docs/current/ai-model-operations-evaluation-llm-evaluation.md`.
