...
# duplicate-code: renewal acceptance keeps its deterministic identity/envelope
# fixtures local; sharing them across acceptance modules would couple independent
# scenario proofs.
# arid: disable
...
# arid: enable
# duplicate-code: this acceptance module owns its PostgreSQL restart fixture so its
# proof remains independently executable rather than coupled to another scenario file.
# arid: disable
def _store(
...
# duplicate-code: this local assertion is part of the renewal acceptance proof shape;
# extracting it would couple independent acceptance scenarios for no domain benefit.
# arid: disable
...
def test_r2_acceptance_renewal_lineage_survives_restart_through_decision_memory(
    ...
    async def scenario() -> None:
        ...
        # duplicate-code: the canonical renewal application call is intentionally
        # asserted inline at the acceptance seam; sharing it with lower-level
        # relationship tests would collapse independent proof layers.
        # arid: disable
        ...
        # duplicate-code: restart reconstruction is a ticket-level acceptance
        # falsifier and stays local rather than sharing setup with persistence tests.
        # arid: disable
