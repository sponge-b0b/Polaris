...
* Material recommendation explanations preserve attribution through `EvidenceClaimReference` bindings to durable packet support and reconstruction references, because recommendation prose must not become detached from the evidence that makes it readiness-safe. (source: docs/adr/0009-decision-evidence-packets-canonical-semantics.md)
