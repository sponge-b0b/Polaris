...
* **Request-scoped governed workflow audit composition** — accepted, implementation pending. A request-scoped application service must resolve the audit service and validate canonical decision evidence before it calls the application-scoped workflow facade, because request lifetime and authoritative evidence must not be reconstructed by interfaces or the runtime. (source: docs/adr/0011-dependency-composition-governed-workflow-audit-composition.md)
