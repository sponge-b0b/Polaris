...
* Actor-resource authorization is a distinct prerequisite to runtime policy and governance: a canonical authorization `DENY` is terminal and governance cannot override it, because permission to act and governance approval are separate authority questions. (source: docs/adr/0020-platform-authorization-contract-cerbos-pdp.md)
