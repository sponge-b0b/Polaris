...
* Policy determines whether an action may occur, while governance determines whether the action should occur or requires approval, because eligibility and authority are distinct concerns. (source: docs/current/platform-architecture-and-operations.md)
