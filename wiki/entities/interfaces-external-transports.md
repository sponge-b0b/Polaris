...
* CLI and backtest governed execution must use the request-scoped governed workflow execution service with canonical evidence, because transport and simulation surfaces cannot synthesize authority/evidence or retain a direct-facade bypass. (source: docs/adr/0011-dependency-composition-governed-workflow-audit-composition.md)
