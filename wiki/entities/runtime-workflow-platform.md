...
* **Tier-specific governed-execution evidence enforcement** — accepted, implementation pending. Enforced facade execution will consume a capability derived from reconstructed canonical evidence: compact runtime provenance for Baseline and a decision-evidence packet for Enhanced/Vigilant. (source: docs/adr/0012-dependency-composition-governed-execution-evidence-contract.md)
