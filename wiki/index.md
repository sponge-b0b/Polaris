...
| [Durable Persistence](entities/durable-persistence.md) | Infrastructure | present | `src/polaris/infrastructure/persistence/postgresql/` | Durable transactional business persistence, immutable history, concurrency, recovery, and replaceable storage adapters. |
...
* [ADR 0005 — Isolate unqualified PostgreSQL dependencies from the GIL-disabled runtime](../docs/adr/0005-platform-isolate-unqualified-persistence-runtime.md) — accepted bounded runtime-qualification exception for the PostgreSQL adapter while preserving free-threaded platform defaults.
